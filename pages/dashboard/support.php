...
<head>
    ...
    <link rel="icon" href="../../assets/img/home-logo.png" type="image/x-icon">
    <title>Support - Tuvoc  </title>
            ...
            <div class="nav-container">
                <a class="navbar-brand" href="./index.php">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <img src="../../assets/img/home-logo.png" height="50px">
                    </div>
                    <div class="sidebar-brand-text"><span>Tuvoc </span></div>
                </a>
                                        ...
                                        <div style="margin-bottom: 0px;"
                                            ...
                                            <div
                                                ...
                                                <label class="form-label" for="signature"><strong>Share any
                                                        issues, feedback, or thoughts about your ing
